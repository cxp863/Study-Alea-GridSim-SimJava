 ...
 *
 * ARGridResource类处理所有高级保留功能。 所有功能均通过其内部或私有方法完成。
 * 注意：将ResourceCharacteristics对象内的分配策略设置为ResourceCharacteristics.ADVANCE_RESERVATION非常重要。 另外，资源的调度程序应该从ARPolicy类扩展。
 *
