 ...
 *
 * 区域GIS是一个简单的区域GridInformationService（GIS）实体，
 * 它执行基本功能，例如存储本地资源列表，以及向其他区域GIS实体询问资源。
 * 如果要实现其他复杂功能，则需要扩展此类并重写processOtherEvent(Sim_event)和/或
 * registerOtherEntity()方法。
 *
