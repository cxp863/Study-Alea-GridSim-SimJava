 ...
 *
 * 生成器，用于告知每个时间间隔发送了多少个数据包以及每个数据包的大小。
 * Output实体使用此生成器生成垃圾数据包或某些后台流量。
 * 此类使用eduni.simjava.distributions软件包，该软件包仅可从SimJava2获得。
 * 如果要使用其他分发包，则需要使用DiscreteGenerator或ContinuousGenerator接口类包装每个源文件。
 *
